...
def t0():
    ...
    scene = PlateShapeScene(n_grid=32, ppc=2, n_seg=2, n_frames=40, sub=4)
...
def ablation(true_yield=3000.0, action_true=(0.30, 0.18), factors=(0.25, 0.5, 1.0, 2.0, 4.0),
             pop=16, elite=4, n_iter=4, out=None):
    ...
    sc = PlateShapeScene(n_grid=32, ppc=2, n_seg=2, n_frames=80, sub=4)
