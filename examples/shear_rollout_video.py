...
Two visuals from examples/shear_cell_3d.py's recorded rollout (out/shear_cell_3d/rollout_3d.npz):
...
Run:  PYTHONPATH=src ../.venv/bin/python examples/shear_rollout_video.py
"""
